<div class="container">
    <h1 class="text-center mt-4">Midnight Dirty Talks</h1>
         <div class="row">
    ...
    <div class="row">
        <div class="col-lg-10 col-md-10 offset-md-1 offset-lg-1">
            <img class="img-fluid" src="<?php echo base_url();?>assets/dist/images/cards/mdt.jpeg" alt="">
        </div>
    </div>

    <div class="row">
        <div class="col-lg-8 col-md-8 offset-md-2 offset-lg-2">
            <h2 class="text-center">Midnight Dirty Talks Order</h2>
            <p class="lead text-center">Please fill in the form below</p>
            <?php echo form_open('submit_midnight_dirty_talks_order');?>
                <div class="form-group">
                    <label>Your Name</label>
                    <input type="hidden" name="name_of_card" value="midnight dirty talks">
